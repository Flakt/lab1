package Vehicles; /**
 * Vehicles.Vehicle is an abstract base class for all vehicles which
 * allows the creation of vehicles with different attributes.
 * <br>
 * A Vehicles.Vehicle object encapsulates all state information necessary
...
public abstract class Vehicle implements Movable {
    ...
    /**
     * Instantiates a new Vehicles.Vehicle.
     */
    protected Vehicle() {
