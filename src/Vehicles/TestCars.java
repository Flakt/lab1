...
public class TestCars {
    /*
    Vehicles.Saab95 saab95 = new Vehicles.Saab95();
    Vehicles.Volvo240 volvo240 = new Vehicles.Volvo240();
    Vehicles.Scania scania = new Vehicles.Scania();
    Vehicles.Scania scania2 = new Vehicles.Scania();
    Vehicles.Langtradare biltransport = new Vehicles.Langtradare();
    Vehicles.Bilfarja bilfarja = new Vehicles.Bilfarja(10);
    ...
    public void testGetModelName() {
        saab95.getModelName();
        assert (saab95.getModelName().equals("Vehicles.Saab95"));
    }
